...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-blue-50 backdrop-blur">
      ...
      {/* Mobile menu */}
      {mobileOpen && (
          <div className="border-t border-indigo-100 bg-white/95 md:hidden">
          <div className="max-h-[70vh] overflow-y-auto px-4 py-4">
            ...
            <div className="flex gap-4 border-t border-indigo-100 pt-4 text-sm font-medium text-slate-700">
